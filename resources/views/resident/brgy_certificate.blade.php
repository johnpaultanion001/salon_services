...
@section('sub-title','Brgy Certificate')
...
<script> 
  $(document).on('click', '#create_record', function(){
      ...
      $('.modal-title').text('Add Barangay Certificate');
  ...
  $('#myForm').on('submit', function(event){
    ...
    $('.form-control').removeClass('is-invalid')
    var action_url = "{{ route('resident.brgy_certificate.store') }}";
    var type = "POST";

    if($('#action').val() == 'Edit'){
        var id = $('#hidden_id').val();
        action_url = "brgy_certificate/" + id;
        type = "PUT";
    }
  ...
  $(document).on('click', '.edit', function(){
      ...
      $.ajax({
          url :"/resident/brgy_certificate/"+id+"/edit",
          dataType:"json",
          beforeSend:function(){
              $("#action_button").attr("disabled", true);
              $("#action_button").attr("value", "Loading..");
