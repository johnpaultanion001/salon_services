      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            <h2 class="text-center title text-white">Barangay Indigency</h2>
          </div>
          <div class="col-md-12 text-right">
            <button class="btn btn-primary btn-raised" name="create_record" id="create_record" >Barangay Indigency</button>
          </div>
...
<script> 
  $(document).on('click', '#create_record', function(){
      ...
      $('.modal-title').text('Add Barangay Indigency');
  ...
  $('#myForm').on('submit', function(event){
    ...
    $('.form-control').removeClass('is-invalid')
    var action_url = "{{ route('resident.barangay_indigency.store') }}";
    var type = "POST";

    if($('#action').val() == 'Edit'){
        var id = $('#hidden_id').val();
        action_url = "barangay_indigency/" + id;
        type = "PUT";
    }
  ...
  $(document).on('click', '.edit', function(){
      $('#formModal').modal('show');
      $('.modal-title').text('Edit Barangay Indigency');
      $('#myForm')[0].reset();
      $('.form-control').removeClass('is-invalid')
      ...
      $.ajax({
          url :"/resident/barangay_indigency/"+id+"/edit",
          dataType:"json",
          beforeSend:function(){
              $("#action_button").attr("disabled", true);
              $("#action_button").attr("value", "Loading..");
