...
<script> 
  $(document).on('click', '#create_record', function(){
      ...
      $('.modal-title').text('Add Certificate Of Residency');
  ...
  $('#myForm').on('submit', function(event){
    ...
    $('.form-control').removeClass('is-invalid')
    var action_url = "{{ route('resident.certificate_of_residency.store') }}";
    var type = "POST";

    if($('#action').val() == 'Edit'){
        var id = $('#hidden_id').val();
        action_url = "certificate_of_residency/" + id;
        type = "PUT";
    }
  ...
  $(document).on('click', '.edit', function(){
      ...
      $.ajax({
          url :"/resident/certificate_of_residency/"+id+"/edit",
          dataType:"json",
          beforeSend:function(){
              $("#action_button").attr("disabled", true);
              $("#action_button").attr("value", "Loading..");
